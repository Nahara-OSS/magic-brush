...
pub trait DynamicContext {
    /// Random value for current stroke.
...
pub enum Sensor {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "pressure"))]
    Pressure,

    /// Azimuth of stylus
    ///
    /// The stylus orientation/facing direction, normalized from 0 -> 360 to 0.00 -> 1.00 range.
    #[cfg_attr(feature = "serde", serde(rename = "azimuth"))]
    Azimuth,
    ...
    #[cfg_attr(feature = "serde", serde(rename = "twist"))]
    Twist,
    ...
    #[cfg_attr(feature = "serde", serde(rename = "jitterStroke"))]
    JitterStroke,
    ...
    #[cfg_attr(feature = "serde", serde(rename = "jitterDab"))]
    JitterDab,
}
